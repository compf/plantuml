...
//	}
	...
	public void moveStartPoint(double dx, double dy) {
		...
		beziers.get(0).rectangleCoordinates.setX1(rectangleCoordinates.getX1() + dx);
		beziers.get(0).rectangleCoordinates.setY1(rectangleCoordinates.getY1() + dy);
...
//	}
	...
	public void moveEndPoint(double dx, double dy) {
		beziers.get(beziers.size() - 1).rectangleCoordinates.setX2(rectangleCoordinates.getX2() + dx);
		beziers.get(beziers.size() - 1).rectangleCoordinates.setY2(rectangleCoordinates.getY2() + dy);
